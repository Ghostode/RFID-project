...
int findguashi(const QString &tagId);
    int addRecords(QString &tagId,QString &time,QString &remark,QString &guashi);//添加记录

   bool updateRecords(QString &tagId,QString &time,QString &remark,QString &guashi);//更新记录
