...
void RegistorWidget::on_btn_Register_clicked()
{
    ...
    QString cardRemark = ui->lineEdit->text();
    QString stunum = ui->lineEdit2->text();
    ...
    if(!registerTableModel->addRecord(cardId,personId,time,stunum,cardRemark))
    {
    ...
    if(!personTableModel->insertRecords(personId,userName,userType,""))
    {
